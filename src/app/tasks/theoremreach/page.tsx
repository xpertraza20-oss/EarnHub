...
export default function TheoremReachPage() {
  ...
  const offerwallUrl = `https://theoremreach.com/surveys?api_key=${apiKey}&user_id=${userId}`;
      ...
      <div className="w-full max-w-3xl mx-auto">
        ...
        <div className="w-full glass-panel rounded-3xl p-8 sm:p-12 border border-dynamic shadow-2xl relative overflow-hidden animate-float">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl font-extrabold text-dynamic tracking-tight mb-4">TheoremReach Surveys</h1>
            
            <p className="text-dynamic-sec text-lg mb-10 max-w-xl leading-relaxed">
              Complete premium surveys matched to your profile. You will be redirected to our secure partner wall. Once completed, your rewards will be automatically credited to your EarnHub balance.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg mb-10 text-left">
              <div className="glass p-4 rounded-xl border border-dynamic flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-dynamic">Instant Payouts</h4>
                  <p className="text-xs text-dynamic-sec mt-0.5">Automated postback credits</p>
                </div>
              </div>
              <div className="glass p-4 rounded-xl border border-dynamic flex items-center gap-3">
                <div className="text-blue-500"><ShieldCheck size={24} /></div>
                <div>
                  <h4 className="text-sm font-bold text-dynamic">Secure Gateway</h4>
                  <p className="text-xs text-dynamic-sec mt-0.5">Verified publisher link</p>
                </div>
              </div>
            </div>
